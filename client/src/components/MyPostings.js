        ...
        <div>
          {mode === 'view' && (
            <View>
              ...
              <Detail>
                <strong>&emsp;Course ID:</strong>&emsp;{` ${listing.courseID}`}
              </Detail>
              <Detail>
                <strong>&emsp;Condition:</strong>&emsp;{` ${listing.condition}`}{' '}
              </Detail>
              <Detail>
                  ...
                  <button
                    ...
                    onClick={() => {
                      fetch(`/api/MyPostings/Listing/${listing.listingID}`, {
                        ...
                        .then(response => {
                          console.log(
                            'listing response: ' + JSON.stringify(response)
                          );
                          if (!response.ok) {
                            throw new Error(response.statusText);
                          }
                      ...
                      fetch(`/api/MyPostings/Book/${isbn}`, {
                        ...
                        .then(response => {
                          console.log(
                            'Book response: ' + JSON.stringify(response)
                          );
                          if (!response.ok) {
                            throw new Error(response.statusText);
                          }
